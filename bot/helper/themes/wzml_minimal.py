...
class WZMLStyle:
    ...
    ST_BN1_NAME = 'CHANNEL'
    ST_BN1_URL = 'https://t.me/TG_Movies4u'
    ST_BN2_NAME = 'UPDATES'
    ST_BN2_URL = 'https://t.me/TG_MOVIES_CLUB'
    ST_MSG = '''<i>Nenem Antuna Antee.</i>
<b>Nikem Panipata Ledha Ra Bewakoof Ani🏃💨</b>'''
    ST_BOTPM = '''<i>Ey Bot Inka Niku Files N Links Pampistundi..Inka Thengatam Modalettu...</i>'''
    ST_UNAUTH = '''<i>You Are not authorized user! Deploy your own Bot Mirror-Leech bot</i>'''
...
↦ <b>Bot Parallel Tasks :</b> {BT}
    ...
    RESTARTING = '<i>Yuddaaniki Siddam Ayi Osta Agu...</i>'
    # ---------------------

    # async def restart_notification(): ---> __main__.py
    RESTART_SUCCESS = '''⌬ <b><i>Nenu Siddham Meeru Siddhama!</i></b>
↦ <b>Date:</b> {date}
↦ <b>Time:</b> {time}
↦ <b>TimeZone:</b> {timz}
↦ <b>Version:</b> {version}'''
...
------------------------------------------\n\n"""
    ...
    STOP_DUPLICATE = 'File/Folder Already Drive Lo Undi.\nIdigo Ni {content} results:'
    # ---------------------
    ...
    # LIST ---> gd_list.py
    LIST_SEARCHING = '<b>Vethukutunna Aagavayya PullaRao..</b>'
    LIST_FOUND = '<b>Niku Kawalsindi Kindha Undi View Kottei<b>'
    LIST_NOT_FOUND = '<b>Lopala Em Ledu Antha Dolle<b>'
    # ---------------------

    # async def mirror_status(_, message): ----> status.py
    NO_ACTIVE_DL = '''<i>Prasantham Ga Undi!</i>
